...
export const getSingleCourse = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      // cache course data, FOR: 10000+ request at the same time
      if (isCacheExist) {
...
export const getCourseByUser = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      // check user purchased this course or not
...
export const addReview = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (course) {
        course.ratings = avg / course.reviews.length; // on example, we have 2 reviews, one 5 one 4 => ratings = (5 + 4) / 2
      }
...
export const getAllCoursesOnlyForAdmin = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
